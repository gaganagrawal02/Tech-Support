...
import './MacbookRepair.css'; // Add your custom styles here
...
const MacbookRepair = () => {
  ...
  const closeCart = () => {
    ...
    const windowACServices = [
      ...
      { name: 'Macbook ISO Licence', description: 'We handle everything! Select this if you are not sure of the issue ', price: 99 },
      { name: 'Macbbok Driver Related issue', description: 'We handle everything! Select this if you are not sure of the issue', price: 99 },
      { name: 'MS Office related issue', description: 'We handle everything! Select this if you are not sure of the issue', price: 99 },
      { name: 'Macbook Password issue', description: 'We handle everything! Select this if you are not sure of the issue', price: 99 },
    ];
    ...
    <div>
      ...
      <div className="ac-repair-container">
        ...
        <div className="ac-repair-content">
          ...
          <h1>Mackbook Service in Delhi Ncr</h1>
          <p>
      ...
      <div className="ac-repair-right">
          <h2>Macbook Service & Quick Support</h2>
      ...
      <div className="why-choose-grid">
        <div className="why-choose-card">
          ...
          <p className="why-choose-card-subheading">
            In-house Mackbook Technicians with 7+ years of experience
          </p>
        </div>
        <div className="why-choose-card">
          <img
            ...
            className="why-choose-image"
          />
          <h3 className="why-choose-card-heading">High-Quality Mackbook Repairing</h3>
          <p className="why-choose-card-subheading">
            High-Quality Macbook Spares, 1-year warranty on spare parts & 7-day warranty on service
          </p>
        </div>
        <div className="why-choose-card">
          <img
